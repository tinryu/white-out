...
const Page = () => {
  ...
  return (
    ...
    <div className="bg-slate-50 rounded-2xl p-6">
      ...
      <div className="flex *:flex *:items-center *:mr-2 mb-4 text-gray-400 text-sm">
    ...
    <div className="flex mt-5 space-x-5">
      <div className="bg-slate-50 rounded-2xl p-6 w-3/4">
      ...
      <div className="bg-slate-50 rounded-2xl p-6 w-1/4">
    ...
    <div className="flex space-x-5 mt-5">
      <div className="w-1/2 bg-slate-50 rounded-2xl p-6">
        ...
        <ul className="*:mb-4 text-sm">
          <li className="flex space-x-2">
            ...
            <div className="w-1/5 flex flex-col items-end">
              ...
              <span className="bg-purple-200 text-purple-400 rounded-full px-2 py-1 text-xs">In Progress</span>
            </div>
          </li>
          <li className="flex space-x-2">
            <div className="w-1/5">
            ...
            <div className="w-1/5 flex flex-col items-end">
              <a href="#" className="my-3">...</a>
              <span className="bg-blue-200 text-blue-400 rounded-full px-2 py-1 text-xs">Pending</span>
            </div>
          </li>
          <li className="flex space-x-2">
            <div className="w-1/5">
            ...
            <div className="w-1/5 flex flex-col items-end">
              <a href="#" className="my-3">...</a>
              <span className="bg-yellow-200 text-yellow-400 rounded-full px-2 py-1 text-xs">Approved</span>
            </div>
          </li>
        </ul>
      </div>
        ...
        <table className="table-fixed w-full text-left">
          ...
          <tbody>
            <tr className="*:py-4">
              ...
              <td>$80.44</td>
              <td>50</td>
              <td><span className="bg-purple-200 text-purple-400 rounded-full px-2 py-1 text-xs">In Progress</span></td>
            </tr>
            <tr className="*:py-4">
              <td>ASOS Right Andree</td>
              <td>$80.44</td>
              <td>50</td>
              <td><span className="bg-green-200 text-green-400 rounded-full px-2 py-1 text-xs">Complete</span></td>
            </tr>
            <tr className="*:py-4">
              <td>ASOS Right Andree</td>
              <td>$80.44</td>
              <td>50</td>
              <td><span className="bg-blue-200 text-blue-400 rounded-full px-2 py-1 text-xs">Pending</span></td>
            </tr>
            <tr className="*:py-4">
              <td>ASOS Right Andree</td>
              <td>$80.44</td>
