...
const page = () => {
  return (
    ...
    <div className="bg-slate-50 rounded-2xl p-6">
      <h5 className="font-bold">Referral Program</h5>
      ...
      <div className="border-gray-300 border-t-2 py-4 flex justify-between">
        <div className="">
        ...
        <button className="bg-gray-300 px-2 text-sm rounded-md h-7">Get Started</button>
      </div>

      <div className="bg-slate-100 p-4 rounded-2xl flex justify-between items-center gap-2">
