  ...
  return (
    ...
    <div className="bg-slate-50 rounded-2xl p-6">
      ...
      <div className="flex justify-between items-center border-b-2 border-gray-200 pb-4 mb-4">
        ...
        <button className="bg-gray-200 px-2 rounded-md text-sm h-7">Get Started</button>
      </div>
      <div className="flex justify-between items-center">
        ...
        <button className="bg-gray-200 px-2 rounded-md text-sm h-7">Create Rule</button>
      </div>
    </div>
