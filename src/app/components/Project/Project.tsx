  ...
  return (
    <>
        <main className="w-full min-h-screen px-6">
            <h1 className="font-bold text-2xl text-gray-700 mb-5 ml-2">My Projects</h1>
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                <div className="flex items-center justify-between rounded-3xl p-5 bg-[#e3f5ff]">
                    ...
                    <p className="flex justify-end">
                        <svg xmlns="http://www.w3.org/2000/svg"width="2em" height="2em" viewBox="0 0 256 256"><path fill="currentColor" d="M216 74h-85.51l-27.9-27.9a13.94 13.94 0 0 0-9.9-4.1H40a14 14 0 0 0-14 14v144.62A13.39 13.39 0 0 0 39.38 214h177.51A13.12 13.12 0 0 0 230 200.89V88a14 14 0 0 0-14-14M40 54h52.69a2 2 0 0 1 1.41.59L113.51 74H38V56a2 2 0 0 1 2-2m178 146.89a1.11 1.11 0 0 1-1.11 1.11H39.38a1.4 1.4 0 0 1-1.38-1.38V86h178a2 2 0 0 1 2 2Z"/></svg>
                    </p>
                    <p className="mt-4 flex flex-wrap">
                        <span>+ 11.02%</span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 14 14"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"><path d="M9.5 3.5h4v4"/><path d="M13.5 3.5L7.85 9.15a.5.5 0 0 1-.7 0l-2.3-2.3a.5.5 0 0 0-.7 0L.5 10.5"/></g></svg>
                    </p>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
                <div className="flex-col items-center p-5 rounded-3xl bg-[#f7f9fb]">
                    <div className="flex justify-between">
                        ...
                        <div className="r-side-t">
                            <Image src="/Facebook.png" alt="facebook" priority={true} width={48} height={48}/>
                        </div>
                    </div>
                    <div className="info flex items-center justify-between pt-6">
                        <div className="ava bg-green-500 rounded-full">
                            <Image src="/Ginger.svg" alt="pepper" width={36} height={36} className="p-1"/>
                        </div>
                    ...
                    <div className="flex justify-between">
                        <div className="l-side-b">
                            <p>36<span className="text-gray-300 text-sm">/</span>49 <span className="text-gray-300 text-sm">Total Tasks</span></p>
                        </div>
                ...
                <div className="flex-col items-center p-5 rounded-3xl bg-[#f7f9fb]">
                    <div className="flex justify-between">
                        ...
                        <div className="r-side-t">
                            <Image src="/Dropbox.png" alt="dropbox" priority={true} width={48} height={48}/>
                        </div>
                    </div>
                    <div className="info flex items-center justify-between pt-6">
                        <div className="ava bg-gray-600 rounded-full">
                            <Image src="/Abby.svg" alt="pepper" width={36} height={36} className="p-1"/>
                        </div>
                        <div className="status flex justify-start items-center">
                    ...
                    <div className="w-full my-6 bg-gray-200 rounded-full h-1.5 dark:bg-gray-700">
                        <div className="bg-gray-600 h-1.5 rounded-full" style={{width: '25%'}}></div>
                    </div>
                    <div className="flex justify-between">
                        <div className="l-side-b">
                            <p>36<span className="text-gray-300 text-sm">/</span>49 <span className="text-gray-300 text-sm">Total Tasks</span></p>
                ...
                <div className="flex-col items-center p-5 rounded-3xl bg-[#f7f9fb]">
                    <div className="flex justify-between">
                        ...
                        <div className="r-side-t">
                            <Image src="/Mi.png" alt="dropbox" priority={true} width={48} height={48}/>
                        </div>
                    </div>
                    <div className="info flex items-center justify-between pt-6">
                        <div className="ava bg-blue-500 rounded-full">
                            <Image src="/Casper.svg" alt="pepper" width={36} height={36} className="p-1"/>
                        </div>
                        <div className="status flex justify-start items-center">
                ...
                <div className="flex-col items-center p-5 rounded-3xl bg-[#f7f9fb]">
                    <div className="flex justify-between">
                        ...
                        <div className="r-side-t">
                            <Image src="/Bitcoin.png" alt="dropbox" priority={true} width={48} height={48}/>
                        </div>
                    </div>
                    <div className="info flex items-center justify-between pt-6">
                        <div className="ava bg-yellow-300 rounded-full">
                            <Image src="/Cuudles.svg" alt="pepper" width={36} height={36} className="p-1"/>
                        </div>
                        <div className="status flex justify-start items-center">
                    ...
                    <div className="w-full my-6 bg-gray-200 rounded-full h-1.5 dark:bg-gray-700">
                        <div className="bg-yellow-300 h-1.5 rounded-full" style={{width: '25%'}}></div>
                    </div>
                    <div className="flex justify-between">
                        <div className="l-side-b">
                            <p>36<span className="text-gray-300 text-sm">/</span>49 <span className="text-gray-300 text-sm">Total Tasks</span></p>
                ...
                <div className="flex-col items-center p-5 rounded-3xl bg-[#f7f9fb]">
                    <div className="flex justify-between">
                        ...
                        <div className="r-side-t">
                            <Image src="/AdobeXD.png" alt="dropbox" priority={true} width={48} height={48}/>
                        </div>
                    </div>
                    <div className="info flex items-center justify-between pt-6">
                    ...
                    <div className="w-full my-6 bg-gray-200 rounded-full h-1.5 dark:bg-gray-700">
                        <div className="bg-mint h-1.5 rounded-full" style={{width: '25%'}}></div>
                    </div>
                    <div className="flex justify-between">
                        <div className="l-side-b">
                            <p>36<span className="text-gray-300 text-sm">/</span>49 <span className="text-gray-300 text-sm">Total Tasks</span></p>
