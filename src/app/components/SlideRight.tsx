...
export const SlideRight = () => {
  return (
    <aside className="w-64 bg-white border-l border-gray-200 dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="px-3 pb-4 overflow-y-auto ">
        <ul className="flex flex-col w-full">
          ...
          <li className="mb-4">
            <a href="#" className="flex flex-row items-center h-10 px-3">
              <span className="text-lg flex items-center bg-[#e5ecf6] rounded-md p-1">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M4.93 4.93A9.969 9.969 0 0 0 2 12c0 2.76 1.12 5.26 2.93 7.07l1.41-1.41A7.938 7.938 0 0 1 4 12c0-2.21.89-4.22 2.34-5.66zm14.14 0l-1.41 1.41A7.955 7.955 0 0 1 20 12c0 2.22-.89 4.22-2.34 5.66l1.41 1.41A9.969 9.969 0 0 0 22 12c0-2.76-1.12-5.26-2.93-7.07M7.76 7.76A5.98 5.98 0 0 0 6 12c0 1.65.67 3.15 1.76 4.24l1.41-1.41A3.99 3.99 0 0 1 8 12c0-1.11.45-2.11 1.17-2.83zm8.48 0l-1.41 1.41A3.99 3.99 0 0 1 16 12c0 1.11-.45 2.11-1.17 2.83l1.41 1.41A5.98 5.98 0 0 0 18 12c0-1.65-.67-3.15-1.76-4.24M12 10a2 2 0 0 0-2 2a2 2 0 0 0 2 2a2 2 0 0 0 2-2a2 2 0 0 0-2-2"/></svg>
              </span>
              <span className="ml-3 text-xs">
          ...
          <li className="mb-4">
            <a href="#" className="flex flex-row items-center h-10 px-3">
              <span className="bg-blue-500 rounded-full">
                <Image priority={true} src="/Abby.svg" alt="pepper" width={26} height={26} className="p-1"/>
              </span>
          ...
          <li className="mb-4">
            <a href="#" className="flex flex-row items-center h-10 px-3">
              <span className="bg-gray-500 rounded-full">
                <Image priority={true} src="/Casper.svg" alt="pepper" width={26} height={26} className="p-1"/>
              </span>
